...
},{"./url-alphabet/index.js":"node_modules/nanoid/url-alphabet/index.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var radioNano = document.getElementById('nanoid');
var radioUuid = document.getElementById('uuid');
var numberOfIds = document.getElementById('number');
var arrayOfIds = []; // create uuid

var createUUID = function createUUID(number) {
  for (var i = 0; i < number; i++) {
    arrayOfIds.push((0, _uuid.v4)());
  }
}; // create nanoid


var createNanoID = function createNanoID(number) {
  for (var i = 0; i < number; i++) {
    arrayOfIds.push((0, _nanoid.nanoid)());
  }
...
createButton.addEventListener('click', function () {
  ...
  arrayOfIds.forEach(function (el) {
    var listElement = document.createElement("LI");
    var textListElement = document.createTextNode(el);
...
},{"uuid":"node_modules/uuid/dist/esm-browser/index.js","nanoid":"node_modules/nanoid/index.browser.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
